...
```bash
bocker image build testdata/mise/node/Incusfile.yaml
bocker image build testdata/mise/python/Incusfile.yaml
bocker image build testdata/mise/rust/Incusfile.yaml
```
