# MISE Incusfile end-to-end fixtures
...
```bash
bocker image build --permission super testdata/mise/node/Incusfile
bocker image build --permission super testdata/mise/python/Incusfile
bocker image build --permission super testdata/mise/rust/Incusfile
```
